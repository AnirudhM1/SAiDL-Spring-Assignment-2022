...
from dqn.model_simclr import DQN
...
class DQNAgent:
    ...
    def optimise_td_loss(self):
        ...
        input_q_values, self_supervised_loss = self.policy_network(states)
        self.policy_network.calculate_representation_loss=False
        input_q_values = input_q_values.gather(1, actions.unsqueeze(1)).squeeze()

        loss = F.smooth_l1_loss(input_q_values, target_q_values) + self_supervised_loss.to(device)
