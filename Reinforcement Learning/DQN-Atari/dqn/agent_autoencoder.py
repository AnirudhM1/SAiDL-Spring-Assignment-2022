...
from dqn.model_autoencoder import DQN
...
class DQNAgent:
    ...
    def optimise_td_loss(self):
        ...
        input_q_values, reconstruction = self.policy_network(states)
        input_q_values = input_q_values.gather(1, actions.unsqueeze(1)).squeeze()

        # print(states.shape)

        loss = F.smooth_l1_loss(input_q_values, target_q_values) + F.mse_loss(reconstruction, states)
