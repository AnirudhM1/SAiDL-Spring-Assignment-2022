...
#     def forward(self, x):
#         conv_out = self.encoder_conv(x).view(x.size()[0],-1)
#         encoder_out = self.encoder_fc(conv_out)
#         return encoder_out

#     def set_default_params(self, model):
#         for param1, param2 in zip(self.parameters(), model.parameters()):
#             param1.data = param2.data
    
#     def set_params(self, model_parameters, m=0.999):
#         for param1, param2 in zip(self.parameters(), model_parameters):
#             param1.data = m*param1.data + (1-m)*param2.data
